...
export const navTree = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "FINATO", to: "/products/finato" },
      { label: "TruAgent", to: "/products/truagent" },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Product Demos", to: "/resources/demos" },
      { label: "Analyst Reports", to: "/resources/analyst-reports" },
      { label: "White Papers", to: "/resources/whitepapers" },
      { label: "Brochures", to: "/resources/brochures" },
      { label: "Thoughtcast", to: "/resources/thoughtcast" },
      { label: "Webinars", to: "/resources/webinars" },
      { label: "Infographics", to: "/resources/infographics" },
      { label: "Blogs", to: "/resources/blogs" },
      { label: "Newsletters", to: "/resources/newsletters" },
